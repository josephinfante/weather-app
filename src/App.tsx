  ...
  return (
    <>
      <section className="h-screen py-5 flex flex-col justify-between">
        ...
        { weather.location.name && <div ref={containerRef} className="flex justify-between items-center w-full overflow-x-auto h-[200px]"><WeatherCard Forecast={weather.forecast}/></div>}
      </section>
